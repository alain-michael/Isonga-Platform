...
const InvestorDetailView: React.FC = () => {
  ...
  const saveProfile = async () => {
    ...
    try {
      await investorAPI.update(id!, profileForm);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button onClick={openProfileEditor} className="btn-primary flex items-center space-x-2">
      ...
      {editingProfile && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-neutral-800 rounded-2xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white dark:bg-neutral-800 border-b border-neutral-200 dark:border-neutral-700 px-6 py-4 flex items-center justify-between">
              <h3 className="text-xl font-bold text-neutral-900 dark:text-neutral-100">Edit Partner Profile</h3>
              <button onClick={() => setEditingProfile(false)} className="text-neutral-400 hover:text-neutral-600">
                <Save className="h-5 w-5 opacity-0" />
              </button>
            </div>
            <div className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Organization Name</label>
                <input type="text" value={profileForm.organization_name} onChange={(e) => setProfileForm({ ...profileForm, organization_name: e.target.value })}
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Investor Type</label>
                <select value={profileForm.investor_type} onChange={(e) => setProfileForm({ ...profileForm, investor_type: e.target.value })}
                  className="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-100">
                  {Object.entries(investorTypeDisplay).map(([k, v]) => <option key={k} value={k}>{v}</option>)}
                </select>
              </div>
              <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Contact Email</label>
                ...
                <div>
                  ...
                  <input type="text" value={profileForm.contact_phone} onChange={(e) => setProfileForm({ ...profileForm, contact_phone: e.target.value })}
                    className="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-100" />
                </div>
              </div>
              <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Min Investment (RWF)</label>
                  <input type="number" value={profileForm.min_investment} onChange={(e) => setProfileForm({ ...profileForm, min_investment: Number(e.target.value) })}
                    className="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-100" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1">Max Investment (RWF)</label>
                  <input type="number" value={profileForm.max_investment} onChange={(e) => setProfileForm({ ...profileForm, max_investment: Number(e.target.value) })}
                    className="w-full px-3 py-2 border border-neutral-300 dark:border-neutral-600 rounded-lg bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-100" />
                </div>
              </div>
            </div>
            <div className="sticky bottom-0 bg-white dark:bg-neutral-800 border-t border-neutral-200 dark:border-neutral-700 px-6 py-4 flex gap-3">
              <button onClick={() => setEditingProfile(false)} className="flex-1 px-4 py-2 border border-neutral-300 dark:border-neutral-600 text-neutral-700 dark:text-neutral-300 rounded-lg hover:bg-neutral-50 transition">Cancel</button>
              <button onClick={saveProfile} disabled={profileSaving} className="flex-1 bg-primary-600 hover:bg-primary-700 disabled:opacity-50 text-white px-4 py-2 rounded-lg transition flex items-center justify-center gap-2">
